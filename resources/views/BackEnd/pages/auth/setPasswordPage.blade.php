...
<html lang="en" data-bs-theme="dark">
  <head>
    ...
    <title>Job Pules Set Password </title>
      ...
      <div class="container d-flex align-items-center">
        <div class="form-holder has-shadow">
          <div class="row">
            ...
            @endif
                <div class="content">
                  <form action="{{ route('setPasswordCore') }}" class="form-validate" method="POST">
                    @csrf


                    <div class="form-group">
                        <input type="hidden" value="{{session('email')}}" name="email">
                      <input id="login-username" type="text" name="password" required data-msg="Please enter your useremail" class="input-material">
                      <label for="login-username" class="label-material">Password</label>
                    </div>
                    <div class="form-group">
                        <input id="login-username" type="text" name="confirmPassword" required data-msg="Please enter your useremail" class="input-material">
